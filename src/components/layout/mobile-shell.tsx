  ...
  return (
    <div className="min-h-screen px-0 sm:px-4 sm:py-6">
      <div className="mx-auto w-full max-w-[28rem]">
        <div className="relative min-h-screen overflow-hidden bg-base-100 sm:min-h-[calc(100vh-3rem)] sm:rounded-[2rem] sm:border sm:border-base-300 sm:shadow-2xl sm:shadow-stone-950/10">
